...
\subsubsection{Word}
\hspace{1cm}
ตารางนี้มีไว้สำหรับเก็บข้อมูลต่าง ๆ ของคำศัพท์
\begin{table}[h]\centering
	...
	\begin{tabular}[t]{|p{.02\linewidth}|p{.15\linewidth}|p{.15\linewidth}|p{.025\linewidth}|p{.25\linewidth}|p{.25\linewidth}|}
		...
		FK                        & root\_id                       & varchar(32)                                                                                                                                   & No                        & \begin{tabular}[c]{@{}l@{}}เลขสำหรับระบุรากของคำศัพท์\\ เป็นตัวเลขที่ต่อเนื่องกันไปไม่ซ้ำ\\ \end{tabular}             & 1                                                                                                                               \\ \hline
...
\hspace{1cm}
ตารางนี้มีไว้สำหรับเก็บข้อมูลรากของคำศัพท์
\begin{table}[h]\centering
...
\subsubsection{User}
\hspace{1cm}
ตารางนี้มีไว้สำหรับเก็บข้อมูลต่าง ๆ ของผู้ใช้
\begin{table}[h]\centering
...
\hspace{1cm}
ตารางนี้มีไว้สำหรับเก็บข้อมูลคำศัพท์ที่ผู้ใช้เคยเรียนไปแล้ว
\begin{table}[h]\centering
